...
BaseUrl = "https://groups.csail.mit.edu/mac/ftpdir/scheme-7.5/7.5.17/doc-html/"
DownDir = "mitscheme/"

def downThirdNode(multi, successList, failedList)
  downNodes(multi, successList, failedList, BaseUrl, DownDir, :eventAllComplete);
end

def downSecondNode(multi, successList, failedList)
  downNodes(multi, successList, failedList, BaseUrl, DownDir, :downThirdNode);
end

parseDownLoadUrl(BaseUrl, DownDir, "doc.html", :downSecondNode)
